...
//     { id: 1, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", claim: "Pick-Up" , dateReq: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "To be approve" },
//     { id: 5, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", claim: "Pick-Up" , dateReq: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "To be approve" },
//     { id: 4, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", claim: "Pick-Up" , dateReq: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "To be approve" },
      ...
      <div class="div-2">
        <div class="column">
          <div class="div-3">
            ...
            <router-link to="/adminP" type="button">
              <div class="div-9">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/e267ccf57559751ed4a6edddaec7ad58b0b984bf4825d85e20169dddae3d95bc?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                  class="img-3"
                />
                <div class="div-6">Payments</div>
              </div>
            </router-link>
            <router-link to="/adminC" type="button">
              <div class="div-9">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/51b6ca07e8ddfd8dbd6ac6f38d6c07d15cd15138d86e73afd00dddd03086a9ca?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                  class="img-4"
                />
                <div class="div-6">Confirmation</div>
              </div>
            </router-link>
            <router-link to="/adminA" type="button">
              <div class="div-9">
                <img
                  loading="lazy"
...
<!-- until here -->
            ...
            <router-link to="/adminF" type="button">
              <div class="div-9">
                <img
                  loading="lazy"
          ...
          <div class="div-17">
            <div class="div-18">
              <div class="div-19">
                ...
                <div class="div-21">CONFIRMATION</div>
                
                <div class="div-48-">
                    You can update the received status, by marking it as received or unreceived.
              </div>
...
<!-- <div class="arrangement">
          ...
          <tbody>
            ...
            <tr v-for="category in categories" :key="category.id">
              ...
              <td class="">{{ category.claim }}</td>
              <td class="">{{ category.release }}</td>
              
              <td class="">
                <button type="button" class="btn btn-outline-dark" data-mdb-ripple-init data-mdb-ripple-color="dark">unreceived</button>
                <button type="button" class="btn btn-dark" data-mdb-ripple-init>received</button>
            </td>
      ...
      <DataTable :value="documentRequests" ref="dt"
     :pt="{
      table: 'custom-table',
      ...
      <Column header="Actions">
        <template #body="slotProps">
          <Button label="View" @click="showDetails(slotProps.data)" />
          <Button label="Received" @click="updateStatus(slotProps.data.request_id)" />
        </template>
      </Column>
    </DataTable>
    <Dialog header="Document Request Details" v-model:visible="displayModal" :modal="true" :closable="true">
      <div v-if="selectedRequest">
        ...
        <div v-if="selectedRequest.claiming_method === 'Courier' && selectedRequest.courier_info">
          ...
          <p><strong>Address:</strong> {{ selectedRequest.courier_info.present_address }}</p>
