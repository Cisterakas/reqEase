...
const categories = ref([
    { id: 1, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", claim: "Pick-Up" , dateReq: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "Canceled" },
    { id: 5, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", claim: "Pick-Up" , dateReq: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "Received" },
    { id: 4, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", claim: "Pick-Up" , dateReq: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "Failed" },
          ...
          <div class="div-17">
            <div class="div-18">
              <div class="div-19">
                ...
                <div class="div-21">HISTORY</div>
                
                <div class="div-48-">
                    You can view all transactions, by clicking view.
              </div>
...
<div class="arrangement">
          ...
          <tbody>
            ...
            <tr v-for="category in categories" :key="category.id">
              ...
              <td class="">
                <span v-if="category.status === 'Canceled'" class="badge rounded-pill badge-warning">{{ category.status }}</span>
                <span v-else-if="category.status === 'Received'" class="badge rounded-pill badge-success">{{ category.status }}</span>
                <span v-else-if="category.status === 'Failed'" class="badge rounded-pill badge-danger">{{ category.status }}</span>
            </td>
