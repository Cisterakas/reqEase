...
const categories = ref([
    { id: 1, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", receipt:  "https://drive.google.com/file" , paymentDate: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "To be approve" },
    { id: 5, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", receipt:  "https://drive.google.com/file" , paymentDate: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "To be approve" },
    { id: 4, studentNum: "22000000123", studentName: "Kim Namjoon", requestedDocument: "Certificate of Enrollment, Certifica", receipt:  "https://drive.google.com/file" , paymentDate: "11 / 03 / 23", amount: "180.00", release: "11 / 06 / 23", status: "To be approve" },
...
<InputText class="form-outline" v-model="filters['global'].value" placeholder="Search..." />
    ...
    <Column field="request_number" header="Request Number" sortable></Column>
      ...
      <Column field="document_names" header="Documents" sortable></Column>
      <Column field="receipt_link" header="Receipt Link">
  <template #body="slotProps">
    <a :href="slotProps.data.receipt_link" target="_blank">{{ slotProps.data.receipt_link }}</a>
  </template>
</Column>
      ...
      <Column header="Actions">
        <template #body="slotProps">
          <div>
            <Button severity="contrast" raised label="Edit" @click="editPayment(slotProps.data)"></Button>
          <Button severity="success" rounded label="Paid" @click="updateStatus(slotProps.data, 'To Receive')"></Button>
          <Button severity="secondary" raised label="Decline" @click="updateStatus(slotProps.data, 'Denied Request')"></Button>
