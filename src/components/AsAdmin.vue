...
<template>
    ...
    <div class="material-textfield">
      <input placeholder=" " type="text">
      <label>Suffix <b>(optional)</b> </label>
    </div>
    <div class="material-textfield">
      <input placeholder=" " type="text">
  ...
  <div>
    ...
    <div class="div-2-">
      <span
        ...
        "
        >Please wait for the <b>Registrar’s Approval</b> and you will receive an </span
      >
        <span
        style="
          font-family: Poppins, sans-serif;
    ...
    <router-link to="/" type="button" class="div-3-">DONE</router-link>
