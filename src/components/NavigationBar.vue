    ...
    <div class="div-2">
      ...
      <div class="div-3">
        ...
        <div class="div-5">
          ...
          for maintaining students' private documents. It is in charge of
          preserving the accuracy of the records in its custody and making them
          accessible upon request through ReqEase: Registrar Document Request
          Suite.
        </div>
      </div>
    </div>
