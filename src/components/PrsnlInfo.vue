      ...
      <div class="column">
        <div class="div-3">
          <div class="div-4">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/d13c5e0d-1894-40a0-b7a2-b8ba9e317a36?"
              class="img"
            />
            <div class="div-5">ONLINE STUDENT RECORDS APPLICATION</div>
          </div>
          <div class="div-6">
            <div class="div-7">
              <span
                style="
                  ...
                  font-weight: 700;
                "
                >Read the items below, before proceeding with your online
                application.<br
              /></span>
              <ul>
                <li>
