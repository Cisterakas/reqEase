...
<!-- until here -->
            ...
            <div class="div-9">
                ...
                <div type="button" @click="logout" class="div-16">LOGOUT</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div v-for="(column, index) in columns" :key="index" class="column-3">
        <div class="div-27">
          ...
          <div class="div-30">
            ...
            <div class="div-46">
              <div class="div-47">Admin Request</div>
              <div class="div-48">
                You can view and update the new account status, marking it as deny or approved.
              </div>
            </div>
